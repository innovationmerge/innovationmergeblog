...
print(len(f_names))
for k in range(2,len(f_names),1):
    if k == 4:
        putTitleText("Feature 5 - Spectral Spread")
        cv2.waitKey(1000)
        ...
        putTitleText("Feature 6 - Spectral entropy")
        cv2.waitKey(1000)
        plt.subplot(1,1,1); plt.plot(F[k,:]); plt.xlabel('Frame no'); plt.ylabel(f_names[k]) ; plt.title('iNNovationMerge');
        ...
        putTitleText("Feature 7 - Spectral Flux")
        cv2.waitKey(1000)
        plt.subplot(1,1,1); plt.plot(F[k,:]); plt.xlabel('Frame no'); plt.ylabel(f_names[k]) ; plt.title('iNNovationMerge');
        ...
        putTitleText("Feature 8 - Spectral rolloff")
        cv2.waitKey(1000)
        plt.subplot(1,1,1); plt.plot(F[k,:]); plt.xlabel('Frame no'); plt.ylabel(f_names[k]) ; plt.title('iNNovationMerge');
        ...
        putTitleText("Feature 10 - Chroma Vector")
        cv2.waitKey(1000)
        plt.subplot(1,1,1); plt.plot(F[k,:]); plt.xlabel('Frame no'); plt.ylabel(f_names[k]) ; plt.title('iNNovationMerge');
        ...
        putTitleText("Feature 11 - Chroma Deviation")
        cv2.waitKey(1000)
        plt.subplot(1,1,1); plt.plot(F[k,:]); plt.xlabel('Frame no'); plt.ylabel(f_names[k]) ; plt.title('iNNovationMerge');
